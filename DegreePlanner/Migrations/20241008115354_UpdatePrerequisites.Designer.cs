...
namespace DegreePlanner.Migrations
{
    ...
    [Migration("20241008115354_UpdatePrerequisites")]
    partial class UpdatePrerequisites
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SubjectSubject", b =>
                {
                    b.Property<int>("PrerequisiteForSubjectId")
                        .HasColumnType("int");

                    b.Property<int>("PrerequisitesSubjectId")
                        .HasColumnType("int");

                    b.HasKey("PrerequisiteForSubjectId", "PrerequisitesSubjectId");
            ...
            modelBuilder.Entity("SubjectSubject", b =>
                {
                    b.HasOne("DegreePlanner.Data.Subject", null)
                        .WithMany()
                        .HasForeignKey("PrerequisiteForSubjectId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
